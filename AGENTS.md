# AGENTS.md — AI Assistant Rules for `mightystandard2`
...
> **Development context:** This repo may be cloned inside `~/code-projects/projects/active/mightystandard2/` as part of Jon's local development monorepo. See that monorepo's `AGENTS.md` for workspace-wide conventions.
...
If this repo is cloned inside `~/code-projects/projects/active/mightystandard2/`:
